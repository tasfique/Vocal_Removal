package com.csci366.july2020.tasfique_enam.vocalremoval;
...
public class MainActivity extends AppCompatActivity {
    ImageView btNoise, btNoVocal, btStop, audioPicture;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btNoVocal = findViewById(R.id.bt_noVocal);
        ...
        btNoVocal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                continuePlaying = true;
